    ...
    >
      ...
      >
        ...
        <div className="flex md:gap-10 gap-1 items-center">
          <button
            className="md:p-2 pr-0 text-black font-bold md:text-4xl text-5xl hover:rounded-2xl hover:bg-gray-100  hover:text-orange-500"
            onClick={() => {
              setPrev(prev <= 0 ? details.length - 1 : prev - 1);
              setNext(next <= 0 ? details.length - 1 : next - 1);
            }}
          ...
          <button
            className="md:p-2 pl-0 text-black font-bold md:text-4xl text-5xl hover:bg-gray-100 hover:rounded-2xl hover:text-orange-500"
            onClick={() => {
              setPrev(prev >= details.length - 1 ? 0 : prev + 1);
              setNext(next >= details.length - 1 ? 0 : next + 1);
            }}
