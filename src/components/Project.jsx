...
const Project = ({ sectionRefs }) => {
  ...
  return (
    <section ref={sectionRefs.project} className="w-full h-full" id="project">
      <div className="p-10 relative">
        <div className="w-[200px] h-[50px] bg-gradient-to-r from-orange-600 to-white rounded-2xl"></div>
        <h1 className="absolute font-caveat text-5xl text-black font-bold z-50 top-3 left-30 shadow-2xs ">
          My Work
        </h1>
        <div
          ref={(el) => {
        ...
        >
          <div className="relative">
            <button
              className="absolute top-[-50px] right-[0px] z-50 p-2 text-black font-bold text-4xl hover:bg-gray-100 hover:rounded-2xl hover:text-orange-600"
              onClick={() => {
            ...
            <button
              className="absolute top-[-50px] left-[800px] z-50 p-2  text-black font-bold text-4xl hover:bg-gray-100 hover:rounded-2xl hover:text-orange-500"
              onClick={() => {
                setPrev(prev >= details.length - 1 ? 0 : prev + 1);
                setNext(next >= details.length - 1 ? 0 : next + 1);
              }}
